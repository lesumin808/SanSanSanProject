...
<link
	...
	rel="stylesheet">
<link rel="stylesheet" href="/board/css/community.css">
</head>
...
<body>
	...
	<section class="post_container">
		<div class="post_community">
			<div class="title">
				<h2>커뮤니티</h2>
				<button type="button" onclick="location.href='/board/write.do'" class="post_btn w m">
					...
					<c:if test="${post.pin==-1}">
						<div class="notice post">
							...
							<div class="post_title">
								<a href="/board/see.do?bno=${post.bno}">${post.title}</a>
							</div>
							<div class="post_info">
								<div class="infos">
