...
<body>
	...
	<section class="post_container">
		<div class="post_community">
			<div class="title">
				<h2>커뮤니티</h2>
				<button type="submit" class="post_btn w">
			...
			<div>
				<ul class="list_btn">
					<li>
						<button type="button" onclick="location.href='/board/see.do?bno=${post.bno-1}'">
			...
			<div class="post">
				...
				<div class="post_title">
					...
					<input type="hidden" name="nname" value='<%=loginAc.getNname()%>'>
							<ul class="comm_area">
								<li style="margin-bottom:20px"><textarea name="content" rows="3" cols="100" 
