	 ...
	 <section class="post_container">
        <div class="join_container">
            <form action="/log/update.do" method="post">
                ...
                <div class="join_btn">
                    <button type="button" onclick="location.href='/log/info.do'" class="post_btn w m">취소하기</button>
                    <button type="submit" class="post_btn w">완료하기</button>
                </div>
            </form>
        </div>
    </section>
